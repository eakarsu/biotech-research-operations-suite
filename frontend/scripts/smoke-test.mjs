...
const adminCookie = await login('admin@biotech-research-operations.local', 'admin123');
const managerCookie = await login('manager@biotech-research-operations.local', 'manager123');
const analystCookie = await login('analyst@biotech-research-operations.local', 'analyst123');
