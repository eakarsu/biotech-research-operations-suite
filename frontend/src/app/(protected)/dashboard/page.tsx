...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Biotech Research Operations Dashboard"
      subtitle="One merged biotech research operations view for Orders, Work Centers, Materials, Quality, Maintenance, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared biotech research operations jobs into one surface. Orders, Work Centers, Materials, Quality, Maintenance, Safety, documents, audit, and AI are presented as platform features.</div>
