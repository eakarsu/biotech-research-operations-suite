...
export const sourceSystems = [
  { name: 'AIBiotechResearchOperationsAssistant', ownership: 'Orders source capabilities and workflows', coverage: ['Orders', 'Work Centers', 'Materials'] },
  { name: 'AIBiotechResearchOperationsOperations', ownership: 'Work Centers source capabilities and workflows', coverage: ['Quality', 'Maintenance', 'Safety'] },
  { name: 'AIBiotechResearchOperationsAnalytics', ownership: 'Materials source capabilities and workflows', coverage: ['Suppliers', 'Yield', 'Exceptions'] },
  { name: 'AIBiotechResearchOperationsWorkflow', ownership: 'Quality source capabilities and workflows', coverage: ['Capacity', 'Analytics', 'Reports'] },
];
