...
PORT="${PORT:-18080}"
DB_NAME="${PGDATABASE:-biotech_research_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Biotech Research Operations Suite"
echo "======================================="
echo
...
echo "Starting biotech research operations suite frontend on http://localhost:$PORT"
echo "Login: admin@biotech-research-operations.local / admin123"
